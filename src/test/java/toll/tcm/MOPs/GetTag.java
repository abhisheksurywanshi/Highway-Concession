...
public class GetTag 	extends BaseClass
{
	...
	{
		ExtentTest GetTag = extent.createTest("GetTag");
		ExetentReportPass test;
		test= new ExetentReportPass(GetTag,"Before Tag Validation","Class selection is null","This stage class selection is null");
...
//			 String data = "34161FA8203288AC"+randomString+randomTagSeries+zeroto99+",5858585858585858585858581"+TagClass+",E2003412012A1B00025EF59E060B00";
	        int rand =BaseClass.randomGenerator(2, 4);
	        String data="";
	        if(Tag_Gun_Type.contains("CHAINWAY")||Tag_Gun_Type.contains("OTHER"))
	        {
	        	
	   		  data = "585858585858585858585858"+TagClass+",34161FA820328EE8"+randomString+randomTagSeries+zeroto99+",E2003412012A1B00025EF59E060B00";
	 		

	        }
	        else if(Tag_Gun_Type.contains("ZEBRA"))
	        {
	        	data = "34161FA8203288AC"+randomString+randomTagSeries+zeroto99+",5858585858585858585858581"+TagClass+",E2003412012A1B00025EF59E060B00";
	        }
//	        else
//	        {
...
//	        	data = BlackListedTags.get(RandomBlacklistedTag)+",5858585858585858585858581"+TagClass+",E2003412012A1B00025EF59E060B00";
//	        }
...
//		 inputStreamForTag = socket.getInputStream();
         ...
         test= new ExetentReportPass(GetTag,"Data To Be Send","String: "+data,"Response is "+response);
...
//        	 captureScreen(driver, "ETC");
  			test= new ExetentReportPass(GetTag,"Invalid Tag","Vehicle pending in queue - 0"," in This stage for barrier Down ");
...
//                	 ExplicitWait(By.name("Tag Transaction Confirmation"));
        	 ...
        	 try 
        	 {
     			...
     			test= new ExetentReportPass(GetTag,"Barrier UP Time","Vehicle pending in queue - 1"," in This stage for barrier up ");
    	     ...
    	     if(Non_Default)
    	        {
    	        	Long Latesttransaction=(Long.valueOf(LastTransaction))+1;
    	       	  ...
    	       	  logger.warn("Non-Default Transaction is found.");
//    	       	    	ExplicitWaitForTag(By.name(latest));
	       ...
	       test= new ExetentReportPass(GetTag,"PC Send Time","Vehicle pending in queue - 1 ","in This stage for barrier down");
...
//           outputStream.write(getdata.getAVCData(response).getBytes());   //TASWADE
    		...
    		test= new ExetentReportPass(GetTag,"Barrier Down Time","Vehicle pending in queue - 0 ","in This stage for barrier down");
...
//                 System.out.println("Responce for AVC:"+responseForAVC);
          	 ...
          	 SetProfilerImage s = new SetProfilerImage(GetTag,TagClass1);
          	ImageVerification i=new ImageVerification(GetTag);
         }
         String parent1=driver.getWindowHandle();
