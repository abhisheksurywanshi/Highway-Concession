...
import toll.tcm.utilities.ExtentReportPath;
...
public class StaticVariables extends JFrame {
	...
	public static String is_extent_exist=readconfig.getExtentExist();
	public static WebDriverWait wait;

	public static DesiredCapabilities capabilities;
	public static WindowsDriver driver;
	static String AvcWindow,parent;
	...
	protected static Socket Tag_socket,AVC_Socket;
	...
	protected static  Multimap<String, String> AVC_Profiler_CDs=  ArrayListMultimap.create();
	protected static Map<String, String> Cash,Card,Wallet;
	protected static Map<String, String> masterPaymentType= new HashMap();
	protected static String[] keysArrayForProfilerVehicleCode;
	...
	protected static String[] keysArrayForCDAndClass;
	...
	protected static ArrayList <String>AvailableExempt4To6=new ArrayList<String>();
	...
	protected static ArrayList <String> KentTollMaster =new ArrayList<String>();
	...
	protected static Map<String, String> CDANDCLASS = new HashMap<String, String>();
	...
	protected static String Exempt_Camera_Exist_Flg,Home_Page_Window,In_Out,IP_Address ,Lane_ID,Toll_ID,AVC_COM,Exit_Avc_Com_No,Lane_CD,WIM_COM_NO,Toll_Name,Is_LSDU,ExemptKey,Is_ETC_Popup="N" , Is_Card_Ref,Is_ManualInsertWeight="N",Is_0Weight_Insert="N",Is_Weight_Delete,Is_Profile_IP,Is_Exempt_Remark,ProfilerPortNo,Tag_Gun_Type;
	...
	protected static String FirstFreeConvoy,Maintanance_ID;
	...
	protected static int subClassStart,subClassEnd,randomsubClass,PaymentTypeSize,PaymentSubTypeSize;
	...
	public static ExtentSparkReporter spark= new ExtentSparkReporter(ExtentReportPath.ExtentReportPath());
